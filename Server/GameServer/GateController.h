...
public:
	...
	// 玩家请求进入某个关卡
	void EnterGate(Player* pPlayer, uint32_t uGateId);	
	// 玩家通知关卡结束
...
private:
	...
	void _RecordEnterGate(Player* pPlayer, uint32_t uGateId);
...
public:
	...
	// 给予玩家奖励
	void GivePrize(Player* pPlayer, uint32_t uGateId, int32_t nResult);
};
